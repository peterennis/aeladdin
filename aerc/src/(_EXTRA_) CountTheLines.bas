...
Err_Handler:
    ...
    Case 29068&     'This error actually occurs in GetModuleLines()
          MsgBox "Erl=" & Erl & " Cannot complete operation." & vbCrLf & "Make sure code is compiled and saved.", vbCritical, "Function CountLines"
      Case Else
         MsgBox "Erl=" & Erl & " Error " & Err.Number & ": " & Err.Description, vbInformation, "Function CountLines"
     End Select
     Resume Exit_Handler
End Function
